...
# def test(models, test_loader, result_path: str):
#     for model in models:
#         model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datacsv', type=str, default='./TrainSet/train_folds_test_thres_55_3x.csv')
    parser.add_argument('--modelroot', type=str, default='./output/tf_efficientnet_v2s_auxdata_thres_55_3x')
    parser.add_argument('--testonly', action='store_true', default=False)
    parser.add_argument('--loadfrom', type=str, default='./output/tf_efficientnet_v2s_auxdata_thres_55_3x')
    parser.add_argument('--result_path', type=str, default='./output/tf_efficientnet_v2s_auxdata_thres_55_3x/result.txt')
    ...
    if not args.testonly:
        ...
        model_weights = ["/home/zby/zby_code/jittor_comp/breast_cancer_zby/outputs/convnextv1_small_focalloss_arcface_triplet_gray_RandomBrightnessContrast/fold0_epoch77.pkl"]
        models = []
